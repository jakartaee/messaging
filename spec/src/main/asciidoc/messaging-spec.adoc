...
* https://github.com/jakartaee/messaging/pull/296[issue_296] Update `JMSDestinationDefinition` Javadoc comment
* https://github.com/jakartaee/messaging/pull/292[issue_292] New constructors in exception classes
