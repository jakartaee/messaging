...
* https://github.com/jakartaee/messaging/pull/296[issue_296] Update `JMSDestinationDefinition`
* https://github.com/jakartaee/messaging/pull/292[issue_292] Introduce new Ctors to set linked exception on creation
